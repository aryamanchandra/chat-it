import { Box, Button, Divider, HStack, Heading, Tab, TabList, Text, VStack } from "@chakra-ui/react";
  ...
  return (
    <VStack py="1.4rem">
      ...
      <VStack as={TabList} border="0">
        <HStack as={Tab} color="blue.800"><Text>Varun</Text></HStack>
        <HStack as={Tab} color="blue.800"><Text>Shashwat</Text></HStack>
        <HStack as={Tab} color="blue.800"><Text>Ashvin</Text></HStack>
      </VStack>
    </VStack>
  );
}
